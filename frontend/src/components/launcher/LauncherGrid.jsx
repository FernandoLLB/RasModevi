...
export default function LauncherGrid() {
  ...
  // grid-cols-3  mobile (<640px)
  // sm: 4 cols   Pi 720px portrait (640px+)
  // md: 5 cols   tablet 768px+
  // lg: 6 cols   desktop 1024px+
  const gridClass = 'grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-5 sm:gap-6 p-4 sm:p-6'

...
export default function FeaturedBanner({ app }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl mb-6 p-6 flex items-center gap-6 animate-fade-up">
      {/* Gradient background */}
      ...
      <div className="relative flex items-center gap-5 flex-1">
        ...
        <div className="flex-1">
          ...
          <h2 className="text-xl font-bold tracking-tight mb-1">{app.name}</h2>
